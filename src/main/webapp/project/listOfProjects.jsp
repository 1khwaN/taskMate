...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/listView.css" />
<script
			...
			<div class="max-width-container flex">
				...
				<div class="radio-container">
					<input type="radio" id="list" name="view-option" value="list"
						class="radio-input" checked onclick="" /> <label
							...
							<li class="task-item">
								<button class="task-button">
									...
									<div class="icon-container">
										<!-- popup view -->
										<iconify-icon icon="weui:eyes-on-outlined" width="24"
											height="24"></iconify-icon>
										<!-- delete icon -->
										<a
											href="/taskMate/ProjectController?action=deleteProject&projectID=<c:out value='${project.projectID}'/>">
											<iconify-icon icon="icomoon-free:bin" width="16" height="16"
												style="cursor: pointer;"
												onclick="confirmation('${project.projectID}')"></iconify-icon>
											<!-- arrow --> <a
											href="/taskMate/TaskController?action=listTask&projectID=<c:out value='${project.projectID}'/>">
