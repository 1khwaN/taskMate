		...
		<form class="form" autocomplete="off" action="ProjectController"
			...
			<c:if test="${not empty project}">
				...
				<textarea name="description" id="description" rows="5"
					class="textarea-input white-background">${project.description}</textarea>
				...
				<div>
					<input type="date" name="endDate" id="endDate"
						class="input white-background" required value="${project.endDate}" />
				</div>
				...
				<ul id="projectStatus" class="status-dropdown white-background"
					style="display: none;">
				...
				<ul id="projectStatus" class="priority-dropdown white-background"
					style="display: none;">
				...
				<input type="hidden" name="projectStatus" id="hidden-priority"
					value="Medium" />

				<div class="text-center">
					<button type="submit"
						class="button regular-button green-background cta-button">Update
						project</button>
				</div>
			</c:if>
