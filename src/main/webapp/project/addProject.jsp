...
<body>
	<div class="form-frame">
		...
		<h1>Add Project</h1>
		<form class="form" autocomplete="off" action="ProjectController"
			method="post">
			<label for="projectName" class="label">Project Name</label> <input
				type="text" name="project-name" id="project-name"
				class="input white-background" placeholder="Enter project name"
				required /> <label for="project-description" class="label">Description</label>
			...
			<input type="hidden" name="projectStatus" id="hidden-status"
				value="To Do" />

			<h2 class="label">Priority</h2>
			<div id="projectPriority"
				class="priority-select white-background flex items-center justify-between cursor-pointer"
				onclick="togglePriorityDropdown()">
				<span id="projectPriority">Medium</span>
				<iconify-icon icon="material-symbols:arrow-drop-down"
					style="color: black" width="18" height="18" class="arrow-icon"></iconify-icon>
			</div>
			<ul id="projectPriority" class="priority-dropdown white-background"
				style="display: none;">
			...
			<input type="hidden" name="projectPriority" id="hidden-priority"
				value="Medium" />

			<div class="text-center">
				<button type="submit"
					class="button regular-button green-background cta-button">Add
					project</button>
			</div>
		</form>
	</div>
