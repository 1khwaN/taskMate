...
<body>
	<div class="form-frame">
		...
		<form class="form" autocomplete="off" action="" method="post">
			<label for="task-name" class="label">Task Name</label> <input
				type="text" name="task-name" id="task-name"
				class="input white-background" placeholder="Enter task name"
				required /> <label for="task-description" class="label">Task
				Description</label>
			<textarea name="task-description" id="task-description" rows="5"
				class="textarea-input white-background"
				placeholder="Enter task description" required></textarea>
			<h2 class="label">Due Date</h2>
			<div class="divided-inputs-container">
				<div>
					<label for="due-day" class="secondary-label">Day</label> <input
						type="number" name="due-day" id="due-day"
						class="input white-background" placeholder="DD" min="1" max="31"
						required />
				</div>
				<div>
					<label for="due-month" class="secondary-label">Month</label> <input
						type="number" name="due-month" id="due-month"
						class="input white-background" placeholder="MM" min="1" max="12"
						required />
				</div>
				<div>
					<label for="due-year" class="secondary-label">Year</label> <input
						type="number" name="due-year" id="due-year"
						class="input white-background" placeholder="YYYY" min="2024"
						required />
				</div>
			</div>
			...
			<input type="hidden" name="task-status" id="hidden-status"
				value="To Do" />
