	...
	<div class="content-container">
			...
			<div class="header flex items-center justify-between">
				...
				<div class="buttons-container">
					...
					<button id="profile-button" class="button icon-button"
						...
						<img src="/img/profLogoDashboard.png" alt="Profile"
							class="profile-icon">
					</button>
		...
		<div class="radio-buttons-container">
			<div class="max-width-container flex">
				...
				<!-- List -->
				<div class="radio-container">
					<input type="radio" id="list" name="view-option" value="list"
						class="radio-input" checked
						onclick="window.location.href='listView.jsp';" /> <label
						for="list" class="radio-label"> <iconify-icon
				...
				<div class="radio-container">
					<input type="radio" id="board" name="view-option" value="board"
						class="radio-input"
						onclick="window.location.href='boardView.jsp';" /> <label
						for="board" class="radio-label"> <iconify-icon
