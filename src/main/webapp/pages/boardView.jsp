...
<body>
	...
	<div class="content-container">
		...
		<div id="notification" class="notification green-background">
			<iconify-icon icon="mdi:check-circle-outline" style="color: black"
		...
		<div class="max-width-container">
			<div class="header flex items-center justify-between">
				...
				<div class="buttons-container">
					<!-- New Profile Button -->
					<button id="profile-button" class="button icon-button"
						onclick="window.location.href='accProfile.jsp';">
						<img src="/taskMate/img/profLogoDashboard.png" alt="Profile"
							class="profile-icon">
					</button>

					<button id="add-task-cta"
		...
		<div class="radio-buttons-container">
			<div class="max-width-container flex">
				...
				<div class="radio-container">
					<input type="radio" id="track" name="view-option" value="track"
						class="radio-input"
						onclick="window.location.href='/taskMate/prodTrackingController';" />
					<label for="track" class="radio-label"> <iconify-icon
							icon="mdi:chart-line" style="color: black" width="24" height="24"></iconify-icon>
          ...
          <div class="radio-container">
            ...
            <label for="list" class="radio-label">
              ...
              <span>List</span>
				...
				<!-- Board -->
				<div class="radio-container">
					<input type="radio" id="board" name="view-option" value="board"
						class="radio-input" checked
						onclick="window.location.href='/taskMate/project/listOfTasks.jsp';" />
					<label for="board" class="radio-label"> <iconify-icon
							icon="ic:round-grid-view" style="color: black" width="24"
							height="24"></iconify-icon> <span>Board</span>
					</label>
				</div>

				<!--Members-->
				<div class="radio-container">
					<input type="radio" id="members" name="view-option" value="members"
						class="radio-input"
						onclick="window.location.href='/taskMate/UserController?action=list';" />
					<label for="members" class="radio-label"> <!-- grid --> <iconify-icon
							icon="tdesign:member-filled" style="color: black" width="24"
							height="24"></iconify-icon> <span>Members</span>
					</label>
				</div>
			</div>
		</div>
		...
		<div id="board-view" class="board-view">
			...
			<div>
				<h2 class="list-header">
					<span class="circle pink-background"></span><span class="text">To
						do</span>
				</h2>
					...
					<li class="task-item">
						<button class="task-button">
							...
							<iconify-icon icon="material-symbols:arrow-back-ios-rounded"
								style="color: black" width="18" height="18" class="arrow-icon"></iconify-icon>
						</button>
					</li>
					<li class="task-item">
						<button class="task-button">
		...
		<div class="overlay-content blue-background">
			...
			<button
				...
				<iconify-icon icon="material-symbols:close-rounded"
					style="color: black" width="26" height="26"></iconify-icon>
			</button>
			...
			<form>
				<div class="form-group">
					<label for="update-task-name" class="header">Task Name</label> <input
						type="text" id="update-task-name" class="form-input value"
						placeholder="Enter task name" />
				</div>

				<div class="form-group">
					<label for="update-task-description" class="header">Task
						Description</label>
					<textarea id="update-task-description" class="form-input value"
						placeholder="Enter task description"></textarea>
				</div>

				<div class="form-group flex items-center">
					<label for="update-task-due-date" class="header min-width">Due
						Date</label> <input type="date" id="update-task-due-date"
				...
				<div class="control-buttons-container">
					...
					<button type="button" id="save-task-btn"
						...
						<iconify-icon icon="material-symbols:check-circle"
							style="color: black" width="24" height="24"></iconify-icon>
					</button>
